...
public class Demo {
    ...
    @Then("^Check for toast msg$")
    public void toastMsg() throws InterruptedException {
        driver.findElement(Locators.views).click();
        driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Popup Menu\"));"));
        driver.findElement(AppiumBy.accessibilityId("Popup Menu")).click();
        driver.findElement(AppiumBy.accessibilityId("Make a Popup!")).click();
        driver.findElement(AppiumBy.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")).click();
        Thread.sleep(1000);
        String message = driver.findElement(Locators.toastMsg).getAttribute("name");
    ...
    public void dragAndDropVerify(){
        driver.findElement(Locators.views).click();
        driver.findElement(Locators.dragDrop).click();
