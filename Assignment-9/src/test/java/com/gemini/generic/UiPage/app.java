...
//        return driver;
    ...
    public void loginSerenity(){
        typeInto(MobileAction.getElement(locator.name),"TestUser");
//        driver.findElement(locator.name).sendKeys("TestUser");

        clickOn(MobileAction.getElement(locator.countryDropdown));
        clickOn(MobileAction.getElement(locator.countrySelect));
        clickOn(MobileAction.getElement(locator.male));
        clickOn(MobileAction.getElement(locator.btnLogin));
    }

    public void validateLogin()
    {
        String title = MobileAction.getTitle();
    ...
    public void shoeSelectSerenity(){
        MobileAction.getElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Nike Blazer Mid '77\"));"));
    }
    ...
    public void addToCartSerenity(){
        clickOn(MobileAction.getElement(locator.productsAddtoCart));
        clickOn(MobileAction.getElement(locator.btnCart));
    }
    ...
    public void website()
    {
        ...
        desiredCapabilities.setCapability("chromedriverExecutable","C:\\Users\\sh.bajaj\\IdeaProjects\\Assignment-4\\driver\\chromedriver.exe");

        MobileAction.waitSec(2);
        MobileAction.click(locator.website);
...
//        Set<String> contexts = ((AndroidDriver) MobileDriverManager.getAppiumDriver()).getContextHandles();
        ...
        MobileAction.typeText(locator.g_search, "Gemini Solutions");
        MobileDriverManager.getAppiumDriver().findElement(locator.g_search).sendKeys(Keys.ENTER);

        MobileAction.waitSec(2);
        MobileAction.click(locator.link);
